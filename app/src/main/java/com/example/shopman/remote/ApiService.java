...
public interface ApiService {
    ...
    Call<CategoryProductResponse> getCategoryProducts(
    ...
    @GET("/api/v1/campaigns/{slug}/products")
    Call<ProductResponse> getCampaignProducts(
            @Path("slug") String slug,
            @Query("page") int page,
    ...
    Call<ProductResponse> getShopProducts(
            @Path("slug") String slug,
            @Query("page") int page,
            @Query("limit") int limit
    );
    ...
    Call<WishlistResponse> getWishlist(
            @Header("Authorization") String authorization, // Thêm header Authorization
            @Query("page") int page,
            @Query("limit") int limit
    );
    @GET("/api/v1/cart")
    ...
    Call<TrendingProductResponse> getTrendingProducts(@Query("cursor") float cursor, @Query("limit") int limit);
