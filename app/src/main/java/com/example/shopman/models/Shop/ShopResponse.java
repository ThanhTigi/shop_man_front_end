...
public class ShopResponse {
    ...
    @SerializedName("metadata") private ShopMetadata metadata;
    ...
    public static class ShopMetadata {
        @SerializedName("message") private String message;
        @SerializedName("metadata") private ShopDetail metadata;
    ...
    public static class ShopDetail {
        @SerializedName("shop") private Shop shop;
    ...
    public static class Shop {
        ...
        @SerializedName("shopLocation") private String shopLocation;
    ...
    public static class Discount {
        ...
        @SerializedName("MaxUses") private int maxUses;
        @SerializedName("UserCounts") private int userCounts;
        @SerializedName("MinValueOrders") private String minValueOrders;
        @SerializedName("status") private String status;
        @SerializedName("ShopId") private int shopId;
        @SerializedName("CampaignId") private Integer campaignId;
